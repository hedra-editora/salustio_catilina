...
(64--63)\footnote{\versal{RAMSEY} (2007: 229).}. Candidato ao consulado para o ano de
...
este era a figura ideal para personificar essa degeneração (\versal{IV}, 1--8).
...
autor realiza\footnote{Baseamo-nos, aqui, na divisão de \versal{SYME} (1964). Embora, na numeração da tradução, adotemos a convenção do texto de base de \versal{ERNOUT} (1996), com capítulos em números romanos e seções ou parágrafos em arábicos, usamos apenas estes no esquema a seguir, nas notas à tradução e no posfácio, para maior comodidade visual.}:  
...
\paragraph{Parte III --- Descoberta da conjuração}
