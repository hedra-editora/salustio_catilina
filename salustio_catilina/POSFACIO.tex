...
principal virtude, a brevidade\footnote{Sêneca, o Rétor,  \emph{Con.} 9.1.14.}. Mas, apesar das críticas, Tito Lívio não se teria furtado à imitação de
...
Gaio Salústio Crispo foi político e historiador do século I a. C., no período
...
\emph{Sallustius Crispus scriptor historicus in Sabinis Amiterni nascitur}; 
...
Diomedes a Dídio (GLK 1.387.4); \emph{Apud} \versal{RAMSEY}  (2007: 2, n. 2).}.   
...
interviesse para subjugar os amotinados\footnote{Apiano, \emph{\versal{BC}} 2.92.387; Dião Cássio, 42.52.1. Cf. \versal{SYME} (1964: 36--37).}. 
...
problema da falta de \emph{auctoritas} (``autoridade'') ao compor seu \emph{ethos} (“caráter”)
...
humanos, que remetem, em última instância, a Platão. De maneira muito concisa, pode-se dizer que Salústio se servirá da escrita da historiografia para se colocar no domínio do \emph{animus} e conquistar a glória imortal e a recordação por parte da posteridade. 


Não há espaço aqui para uma análise detida de todo o prefácio\footnote{Para tal, remetemos o leitor ao ainda excelente artigo de Leeman (1954).}, focaremos nossa análise no parágrafo final, depois de apenas enumerar as principais questões levantadas nos três parágrafos iniciais.
...
\emph{virtus} [“virtude”] como o fulcro de toda a sua obra\footnote{Leia-se a pertinente síntese da questão em \versal{KRAUS} \&\versal{WOODMAN} (1997: 11).}.  
...
grandioso de Roma e da decadência dos costumes, encontra-se \emph{Cat.} 6--13;
...
\section{As versões alternativas dos fatos e  a imparcialidade do historiador}
 ...
 da boca do próprio Crasso, o que coloca o historiador no centro dos acontecimentos e,
 consequentemente, confere-lhe maior credibilidade e autoridade.
...
\emph{inuasere} em lugar de \emph{inuaserunt} [“tomaram de assalto”], e desinências alternativas de substantivos abstratos (a terminação \emph{-tudo}, por exemplo, em lugar de \emph{-tas}, como em \emph{necessitudo} em lugar de \emph{necessitas}.
...
cadência regular e uniforme para tal discurso.  Assim, por
