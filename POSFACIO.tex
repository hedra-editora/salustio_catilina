...
conforme atestam abundantes registros do período\footnote{\emph{Ibid}., p. 300.}.
...
Salústio alcançou enorme popularidade\footnote{\emph{Ibid}., p. 197.},
...
linguagem\footnote{\emph{Ibid}., p. 186.}. 
...
86, e morrido em Roma em 35\footnote{Cf. Jerônimo, p. 151, H:
...
romana\footnote{\emph{Id. ibid..}}. 

Salústio, assim como Cícero, era um \emph{homo novus}, isto é, o primeiro da
...
prerrogativas hereditárias\footnote{\emph{Id. ibid..}}.  Salústio, no prefácio
...
Ânio Milão, apoiado pela ala mais conservadora dos \emph{optimates}\footnote{\emph{Optimates}: termo raramente encontrado no latim antes de Cícero, que o
...
%deixa assim mesmo a citação em caixa alta no texto corrido?
...
\section{Salústio e a historiografia romana}
 ...
 %deixa referências no meio do texto ou padroniza no rodapé?
...
escrita dos feitos de seus ancestrais, requisito fundamental para propugnar
...
interesse\footnote{\emph{Ibid.}, p. 131.}.
...
personificação de toda espécie de excelência particularmente romana\footnote{\emph{Id. ibid.}.}. Ao retirar-se da vida pública, passou a escrever história.
...
sobre a causa dos romanos não possuírem até então (91, data dramática
...
próxima da que Salústio oferece na passagem que citamos acima (\emph{Cat.} \versal{VIII},
...
autoridade, vivenciou o período sobre o qual devia escrever\footnote{\emph{Ibid.}, p. 	77-78.}.
...
tradutores, “na obscuridade”. Pelo segundo, teríamos a ideia de “em silêncio”,
...
digressão da obra, concernente ao passado glorioso de Roma e à sua decadência a
...
escrita da história, que dizem respeito tanto à sua produção como à sua
...
Repare-se que uma nova qualificação, nessa mesma linha, é feita logo em
...
monotonia da narrativa, conferindo-lhe variedade e propiciando deleite à sua
...
idêntica, são empregadas: \begin{quote} Ora, César, quando chegou sua vez e o
  ...
  (\emph{huiuscemodi verba locutus est});\end{quote}
...
\section{Os “documentos''}
 ...
 sua cópia exata (\versal{XXXIV}, 3; \versal{XL}, 4). Assim, no final do capítulo \versal{XXXII}, faz menção à
...
\section{As versões alternativas dos fatos e  a imparcialidade do historiador}
 ...
 seu julgamento a respeito. É o que acontece, por exemplo, no capítulo \versal{XIV}, em
 ...
 consequentemente, confere-lhe maior credibilidade: \begin{quote} Houve,
   ...
   motivar, no capítulo \versal{LIII}, as observações acerca das muitas leituras,
...
\section{A elocução da \emph{Conjuração de Catilina}}
 ...
 % Jorge, este ldots da citação não está aparecendo no texto de saída.
   ...
   outrora, opondo-as à corrupção contemporânea; enfim, ela conferia à sua obra
...
por fim, no nível sintático, sobretudo a parataxe\footnote{Cf. \emph{Ibidem}.}.  A \emph{inconcinnitas} (“assimetria”) é uma das
...
diversas passagens da \emph{Conjuração de Catilina}, como ocorre em \versal{VI}, 4-5:
...
\section{A tradução}
 ...
 de Virgílio, organizada e anotada por Paulo Sérgio de Vasconcellos. O leitor
